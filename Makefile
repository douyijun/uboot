...
ok6410_config	:	unconfig
	...
	@if [ -z "$(findstring ok6410_noUSB_config,$@)" ]; then			\
		echo "RAM_TEXT = 0x5fe00000" >> $(obj)board/samsung/ok6410/config.tmp;\
	else										\
		echo "RAM_TEXT = 0xcfe00000" >> $(obj)board/samsung/ok6410/config.tmp;\
	fi
...
#########################################################################
hw6410_noUSB_config	\
hw6410_config	:	unconfig
	@mkdir -p $(obj)include $(obj)board/homewell/hw6410
	@mkdir -p $(obj)nand_spl/board/homewell/hw6410
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@if [ -z "$(findstring hw6410_noUSB_config,$@)" ]; then			\
		echo "RAM_TEXT = 0x57e00000" >> $(obj)board/homewell/hw6410/config.tmp;\
	else										\
		echo "RAM_TEXT = 0xc7e00000" >> $(obj)board/homewell/hw6410/config.tmp;\
	fi
	@$(MKCONFIG) hw6410 arm arm1176 hw6410 homewell s3c64xx
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
#########################################################################
