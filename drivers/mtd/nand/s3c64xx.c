...
#ifdef CONFIG_SYS_S3C_NAND_HWECC_8BIT
/*
 * This function is called before encoding ecc codes to ready ecc engine.
 * Written by jsgood
 */
 ...
 * Written by jsgood
 */
static int s3c_nand_calculate_ecc_8bit(struct mtd_info *mtd, const u_char *dat,
				  u_char *ecc_code)
{
 ...
 * Written by jsgood
 */
static int s3c_nand_correct_data_8bit(struct mtd_info *mtd, u_char *dat,
				 u_char *read_ecc, u_char *calc_ecc)
{
	int ret = -1;
...
#endif /* CONFIG_SYS_S3C_NAND_HWECC_8BIT */
